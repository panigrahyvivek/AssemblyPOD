sap.ui.define([
    ...
    /**
     * Returns Product OData datasource URI
     */
    RequestProcessor.prototype.getProductDataSourceUri = function () {
        return this.getOwnerComponent().getManifestEntry(Constants.PRODUCT_DS_PATH);
    };

    /**
     * Returns Production REST datasource URI
     */
    RequestProcessor.prototype.getProductionRestDataSourceUri = function () {
        return this.getOwnerComponent().getManifestEntry(Constants.PRODUCTION_DS_REST_PATH);
    };
    
    /**
     * Returns Assembly REST datasource URI
     */
    RequestProcessor.prototype.getAssemblyRestDataSourceUri = function () {
        return this.getOwnerComponent().getManifestEntry(Constants.ASSEMBLY_DS_REST_PATH);
    };
